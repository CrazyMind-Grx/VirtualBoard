...
<section class='container'>
          <hgroup>
            <h1>Bienvenidos a la p&aacute;gina de prueba del servidor en OpenShift en el que vamos a trabajar para nuestro VIrtualBoard</h1>
          </hgroup>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              ...
              <h2>VIrtualBoard</h2>
                <p>La idea general es que se pueda tener una reunion en la que varias personas trabajan con sus moviles o tablets sobre una pantalla compartida de forma sincronizada y con la misma experiencia de usuario que si estuviesen trabajando sobre el papel.</p>
                <h3>1- Funcionalidades de pizarra:</h3>
                <p>Crearemos un lienzo donde se pueda escribir o pintar. La escritura se har&iacute;a con el teclado del dispositivo. A la hora de pintar hay que conseguir una experiencia de usuario lo m&aacute;s realista posible, eso implica:</p>
                <p>A- Que los trazos sean lo m&aacute;s fluido posible.</p>

                    <p>B- Que el grosor del trazo sea sensible a la presi&oacute;n.</p>

                    <p>C- Que el grosor del trazo sea sensible a la velocidad de este.</p>

                    <p>D- Que el feedback de la pantalla sea lo m&aacute;s r&aacute;pido posible, es decir, que no haya lag entre el momento en que se pinta y el momento en que el trazo aparece en la pantalla.</p>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Probando la aplicacion desde OpenShift</h2>

                <h3>A ver si esto funciona..</h3>
